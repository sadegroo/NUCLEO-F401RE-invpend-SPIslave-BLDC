...
#define PID_TORQUE_KP_DEFAULT               2446
#define PID_TORQUE_KI_DEFAULT               3750
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2446
#define PID_FLUX_KI_DEFAULT                 3750
...
#define PID_SPEED_KP_DEFAULT                3512/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                636/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            72
